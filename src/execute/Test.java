...
public class Test {
    public static void main(String[] args){
        ...
        documentBean1.setDocument_id("006768");
        documentBean1.setDocument_name("文件测试2222");
        documentBean1.setDocumentRevision("A");
        documentBean1.setProcessNum(b.getProcessNum());
        data.publishDataFromTc(new String[]{"222222"});
...
//        hzTempMainRecord.setApplicantEmail("zhit876@163.com");
...
//        hzTempMainRecord.setOutCpnyEmail("876369259@qq.com");
//        hzTempMainRecord.setOutCpnyName("222");
//        hzTempMainRecord.setProcessNum("222222");
...
//            hzTempItemRecord.setItemId("006768");
...
//            hzTempItemRecord.setBelProcessNum("222222");
//            hzTempItemRecord.setItemName("222");
//            hzTempItemRecord.setOthers(0);
...
//            hzTempDocumentRecord.setBelProcessNum("222222");
